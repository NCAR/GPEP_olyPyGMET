...
# basic information
path_ens = '/home/gut428/scratch/GMET/EMDNA_out/Estimate'
...
for suffix in suffixall:
    ...
    for y in range(year[0], year[1] + 1):
        for v in range(len(varall1)):
            outfile_stn = outpath + '/stn_' + varall1[v] + '_' + str(y) + suffix + '.mat'
            outfile_ens = outpath + '/ens_' + varall1[v] + '_' + str(y) + suffix + '.mat'
            ...
            for e in range(ensorder[0]-1, ensorder[1]):
                ...
                for m in range(12):
                    ...
                    file_ens = '{}/{}{}/EMDNA_{}.{:03d}.nc4'.format(path_ens,y,suffix,y*100+m+1,e+1)
                    ...
                    for g in range(gnum):
                        data_ens[indym, g, e-ensorder[0]+1] = data_ense[:, rowstn[g], colstn[g]]
                    # save file
