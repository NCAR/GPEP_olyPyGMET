...
Infile_gauge='/home/gut428/GMET/DataInput/ghcn-d_validate/GHCND_Validation_NoLag.nc4';
Inpath_ensemble='/home/gut428/Andrew_CONUS';
...
for vv=1:varnum
    ...
    if ~exist(Outfile_stn,'file')
        f_gauge_data(Infile_gauge,Outfile_stn,[varvv,'_nolag'],leastnumvv,YEAR,Info);
    end
